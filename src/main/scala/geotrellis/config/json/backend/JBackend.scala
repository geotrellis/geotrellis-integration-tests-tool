...
case class JCassandra(name: String, hosts: Seq[String], user: String, password: String, keyspace: String, replicationStrategy: String, replicationFactor: Int) extends JBackend
