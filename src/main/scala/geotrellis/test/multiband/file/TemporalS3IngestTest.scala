...
abstract class TemporalS3IngestTest(implicit configuration: TConfig) extends FileTest[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](configuration) with TemporalS3Load
