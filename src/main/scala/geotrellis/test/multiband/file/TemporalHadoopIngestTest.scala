...
abstract class TemporalHadoopIngestTest(dataset: Dataset) extends FileTest[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](dataset) with TemporalHadoopLoad
