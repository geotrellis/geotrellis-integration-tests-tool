...
abstract class TemporalS3IngestTest(implicit configuration: TConfig) extends HadoopTest[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](configuration) with S3Support with TemporalS3Load
