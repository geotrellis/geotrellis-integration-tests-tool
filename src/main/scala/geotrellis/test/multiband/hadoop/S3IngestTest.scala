...
abstract class S3IngestTest(implicit configuration: TConfig) extends HadoopTest[ProjectedExtent, SpatialKey, MultibandTile](configuration) with S3Support with S3Load
