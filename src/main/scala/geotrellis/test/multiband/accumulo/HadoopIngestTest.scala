...
abstract class HadoopIngestTest(jConfig: JConfig, jCredensials: JCredensials) extends AccumuloTest[ProjectedExtent, SpatialKey, MultibandTile](jConfig, jCredensials) with HadoopLoad
