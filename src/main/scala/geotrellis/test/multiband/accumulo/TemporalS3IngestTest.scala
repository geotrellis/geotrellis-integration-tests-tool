...
abstract class TemporalS3IngestTest(implicit configuration: TConfig) extends AccumuloTest[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](configuration) with TemporalS3Load
