...
abstract class TemporalS3IngestTest(jConfig: JConfig) extends AccumuloTest[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](jConfig) with S3Support with TemporalS3Load
