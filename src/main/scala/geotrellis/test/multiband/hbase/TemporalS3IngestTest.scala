...
abstract class TemporalS3IngestTest(dataset: Dataset) extends HBaseTest[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](dataset) with S3Support with TemporalS3Load
