...
abstract class TemporalHadoopIngestTest(jConfig: JConfig) extends S3Test[TemporalProjectedExtent, SpaceTimeKey, MultibandTile](jConfig) with TemporalHadoopLoad
