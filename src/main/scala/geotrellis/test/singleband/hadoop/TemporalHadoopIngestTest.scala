...
abstract class TemporalHadoopIngestTest(jConfig: JConfig, jCredensials: JCredensials) extends HadoopTest[TemporalProjectedExtent, SpaceTimeKey, Tile](jConfig, jCredensials) with TemporalHadoopLoad
