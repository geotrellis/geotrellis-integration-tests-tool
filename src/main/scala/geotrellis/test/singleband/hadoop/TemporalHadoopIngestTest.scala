...
abstract class TemporalHadoopIngestTest(implicit configuration: TConfig) extends HadoopTest[TemporalProjectedExtent, SpaceTimeKey, Tile](configuration) with TemporalHadoopLoad
