...
abstract class TemporalHadoopIngestTest(jConfig: JConfig, jCredentials: JCredentials) extends HadoopTest[TemporalProjectedExtent, SpaceTimeKey, Tile](jConfig, jCredentials) with TemporalHadoopLoad
