...
abstract class S3IngestTest(jConfig: JConfig, jCredensials: JCredensials) extends HadoopTest[ProjectedExtent, SpatialKey, Tile](jConfig, jCredensials) with S3Support with S3Load
