...
abstract class S3IngestTest(jConfig: JConfig, jCredentials: JCredentials) extends HadoopTest[ProjectedExtent, SpatialKey, Tile](jConfig, jCredentials) with S3Support with S3Load
