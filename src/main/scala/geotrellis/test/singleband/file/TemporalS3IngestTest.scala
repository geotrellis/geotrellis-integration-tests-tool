...
abstract class TemporalS3IngestTest(dataset: Dataset) extends FileTest[TemporalProjectedExtent, SpaceTimeKey, Tile](dataset) with S3Support with TemporalS3Load
