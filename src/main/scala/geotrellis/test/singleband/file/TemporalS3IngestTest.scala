...
abstract class TemporalS3IngestTest(jConfig: JConfig, jCredensials: JCredensials) extends FileTest[TemporalProjectedExtent, SpaceTimeKey, Tile](jConfig, jCredensials) with S3Support with TemporalS3Load
