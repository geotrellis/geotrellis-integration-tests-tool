...
abstract class TemporalS3IngestTest(implicit configuration: TConfig) extends FileTest[TemporalProjectedExtent, SpaceTimeKey, Tile](configuration) with TemporalS3Load
