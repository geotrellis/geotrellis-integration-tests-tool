...
abstract class TemporalS3IngestTest(dataset: Dataset) extends HBaseTest[TemporalProjectedExtent, SpaceTimeKey, Tile](dataset) with S3Support with TemporalS3Load
