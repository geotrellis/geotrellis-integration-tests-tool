...
abstract class TemporalS3IngestTest(jConfig: JConfig, jCredentials: JCredentials) extends AccumuloTest[TemporalProjectedExtent, SpaceTimeKey, Tile](jConfig, jCredentials) with S3Support with TemporalS3Load
